...
```
    ...
    ┌ Info: fmi2Unzip(...): Successfully unzipped 153 files at `/tmp/fmijl_9gXB7b/SpringFrictionPendulum1D`.
    └ @ FMIImport /home/runner/.julia/packages/FMIImport/4SJhD/src/FMI2_ext.jl:76
    ┌ Info: fmi2Load(...): FMU resources location is `file:////tmp/fmijl_9gXB7b/SpringFrictionPendulum1D/resources`
...
```
    ...
    Ptr{Nothing} @0x00007f1a4804afaf
...
```
    ...
    Ptr{Nothing} @0x00007f1a98c33fc0
