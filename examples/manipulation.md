...
```
    ...
    ┌ Info: fmi2Unzip(...): Successfully unzipped 153 files at `/tmp/fmijl_DxlsPb/SpringFrictionPendulum1D`.
    └ @ FMIImport /home/runner/.julia/packages/FMIImport/g4GUl/src/FMI2_ext.jl:76
    ┌ Info: fmi2Load(...): FMU resources location is `file:////tmp/fmijl_DxlsPb/SpringFrictionPendulum1D/resources`
...
```
    ...
    Ptr{Nothing} @0x00007f2f85b6bfaf
...
```
    ...
    Ptr{Nothing} @0x00007f2fd670afc0
