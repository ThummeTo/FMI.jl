...
```
    ...
    [36m[1m[ [22m[39m[36m[1mInfo: [22m[39mfmiUnzipVersion(...): Successfully unzipped modelDescription.xml at `/tmp/fmijl_4mu5WN/SpringFrictionPendulum1D`.
...
```
    ...
    [36m[1m[ [22m[39m[36m[1mInfo: [22m[39mfmiUnzipVersion(...): Successfully unzipped modelDescription.xml at `/tmp/fmijl_mLnJVm/SpringFrictionPendulum1D`.
...
```
    ...
    Address:        Ptr{Nothing} @0x00000000067b80c0
    State:          0
    Logging:        false
    FMU time:       -Inf
    FMU states:     nothing
