...
```
    ...
    BenchmarkTools.Trial: 2 samples with 1 evaluation per sample.
     ...
     Memory estimate[90m: [39m[33m300.75 MiB[39m, allocs estimate[90m: [39m[33m7602423[39m.
...
```
    ...
    BenchmarkTools.Trial: 2 samples with 1 evaluation per sample.
     ...
     Memory estimate[90m: [39m[33m300.75 MiB[39m, allocs estimate[90m: [39m[33m7602438[39m.
