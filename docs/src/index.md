...
Because FMI is under development, a version-independent FMU simulation with the same user interface must be ensured. In addition, users who are new to the topic should also be able to 
