...
```
    ...
    [36m[1m[ [22m[39m[36m[1mInfo: [22m[39mfmiUnzipVersion(...): Successfully unzipped modelDescription.xml at `/tmp/fmijl_EW7Npt/SpringFrictionPendulum1D`.
...
```
    ...
    [36m[1m[ [22m[39m[36m[1mInfo: [22m[39mfmiUnzipVersion(...): Successfully unzipped modelDescription.xml at `/tmp/fmijl_BYMbSx/SpringFrictionPendulum1D`.
...
```
    ...
    Address:        Ptr{Nothing} @0x000000000657a1a0
    State:          0
    Logging:        false
    FMU time:       -Inf
    FMU states:     nothing
